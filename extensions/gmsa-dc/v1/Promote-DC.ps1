...
Invoke-WebRequest -UseBasicParsing https://raw.githubusercontent.com/adelina-t/windows-testing/gmsa/extensions/gmsa-dc/v1/Setup-gMSA.ps1 -OutFile Setup-gMSA.ps1
