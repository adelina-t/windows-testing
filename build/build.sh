...
build_kubelet() {
	...
	pushd $KUBEPATH
        make WHAT=cmd/kubelet KUBE_BUILD_PLATFORMS=windows/amd64 KUBE_VERBOSE=0
...
build_kubeproxy() {
	...
	pushd $KUBEPATH
        make WHAT=cmd/kube-proxy KUBE_BUILD_PLATFORMS=windows/amd64 KUBE_VERBOSE=0
...
build_kubectl() {
	...
	pushd $KUBEPATH
        make WHAT=cmd/kubectl KUBE_BUILD_PLATFORMS=windows/amd64 KUBE_VERBOSE=0
